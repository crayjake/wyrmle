// Archived lessons used only to verify old saved-game presentation.
import {
...
import type { LetterStrikeEncounter, LetterStrikeGem, LetterStrikeState } from '../../src/game/letterStrike.ts'
