...
export default function WyrmLifeMeter({ lives, maximum, dockRef, hidden = false, animateLives = false }: {
  lives: number
  maximum: number
  ...
  return <span ref={dockRef} className="wyrm-life-meter" data-decoding={hidden || undefined} data-animate-lives={animateLives || undefined} aria-hidden="true">
