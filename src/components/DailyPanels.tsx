...
export function HelpPanel({ onClose, longWordRule, onReplayTutorial, anyRecognizedGrammar = false, hasGrammarModifiers = false, definitionBacked = false, finiteRefills = false }: PanelProps & {
  ...
  return (
    <DailyDialog title="How to play" subtitle="One puzzle each day" onClose={onClose}>
      <div className="daily-help">
        ...
        <p>Each valid word costs one life. {finiteRefills ? 'Used tiles are replaced while refills remain.' : 'Used tiles are replaced.'} Removing the final enemy letter wins even when it spends your final life.</p>
